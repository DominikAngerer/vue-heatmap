...
function drawChart() {
  ...
  dayRects = svg.selectAll('.day-cell')
    ...
    function countForDate(d) {
      var count = 0;
      var match = chart.data().findForHeatmap(function (element, index) {
...
if (!Array.prototype.findForHeatmap) {
  Array.prototype.findForHeatmap = function (predicate) {
    if (this === null) {
      throw new TypeError('Array.prototype.findForHeatmap called on null or undefined');
    }
